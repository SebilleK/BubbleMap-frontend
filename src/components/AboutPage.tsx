	...
	return (
		<div className='bg-cover bg-center h-screen' style={{ backgroundImage: `url(${bubbleteaImage})` }}>
			...
			<div className='flex flex-col items-center'>
				<div className='w-1/2 mt-44 mb-44 p-14 bg-white rounded shadow text-lg'>
					<Accordion type='single' collapsible className='w-full '>
						...
						<AccordionItem value='item-2'>
							...
							<AccordionContent className='text-base'>I thought it would be a fun idea and it's also my Full Stack Webdev course final project! Check out its Github repository here.</AccordionContent>
						</AccordionItem>
